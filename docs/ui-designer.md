...
- [doc-reviewer](doc-reviewer.md#design-review) — Reviews design artifacts against PRD and for consistency
- [doc-spec-gen](doc-spec-gen.md) — Generates tech specs that reference design artifacts
- [doc-researcher](doc-researcher.md) — Creates the PRD that drives design decisions
