...
1. Reads the proposal's [Change Manifest](doc-researcher.md#change-manifest)
...
After verification, if system docs reference UI features but no design artifacts exist in `docs/designs/`, the skill suggests running `/ui-designer setup`.
...
```bash
/doc-reviewer sync                    # Full scan — all claims
/doc-reviewer sync --since main~10    # Last 10 commits
/doc-reviewer sync --since v1.0.0     # Since tag
/doc-reviewer sync --since 2026-01-15 # Since date
```
...
Validates design artifacts against system docs and for internal consistency. Separated from [ui-designer](ui-designer.md) intentionally — creation and validation are different concerns.
...
- [doc-researcher](doc-researcher.md) — Generates proposals that this skill reviews
- [doc-spec-gen](doc-spec-gen.md) — Generates specs from verified system docs
- [ui-designer](ui-designer.md) — Creates design artifacts that this skill reviews
