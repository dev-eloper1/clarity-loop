...
If tokens are incomplete: "Design system hasn't been generated yet. Run `/ui-designer tokens`
...
`{docsRoot}/specs/UI_SCREENS.md`. Run `/ui-designer build-plan` to generate implementation
