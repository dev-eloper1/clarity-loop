...
Reference for the `doc-spec-gen review` mode. After specs have been generated from
verified system docs, this check ensures all specs are consistent with each other and
with the source system docs.

### When to Run

Run after `/doc-spec-gen generate` has produced specs in `docs/specs/`. This is the
final quality gate before implementation handoff.
