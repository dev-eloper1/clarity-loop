...
| Form Section | Organism | Heading + 3× Input with Label + Button row | Create Task, Edit Task, User Settings | Medium (3 features) | Medium |
| Navigation Sidebar | Organism | Logo + 5× (Icon + Link) + Avatar + Name | All main screens | Low (single instance) | High |
...
|-----------|------------|-------------------|-------------|------------|
| Task List Item | Checkbox + Heading + Badge × 2 + Icon Button | Task List, Search, Filters, Today View | Medium | Medium |
| Card | Header (Heading + Icon Button) + Body + Footer (Buttons) | Dashboard, Feature Lists, Summaries | Medium | Medium |
| Form Section | Heading + Input with Label × N + Button Row | Create Task, Edit Task, Settings | Medium | Medium |
...
- Form Section — "Create Note" form = Heading + 2× Input with Label + Button row
...
**Wrong:**
> "We need Button, Input, Select, Checkbox, Radio, Badge, Card, Modal, Toast, Avatar, Dropdown, Tabs, Accordion..."

**Right:**
> "Based on the PRD, we need: Button (used in 6 features), Input (used in 4 features), Task List Item (used in 3 features), Form Section (used in 2 features)."
...
> Organisms: Form Section (contains buttons, inputs, labels)

**Right:**
> Atoms: Button, Input, Label
> Molecules: Input with Label (composes Label + Input + Error)
> Organisms: Form Section (composes Heading + 3× Input with Label + Button Row)
...
**Wrong:**
> "Dashboard Header" organism — used only on Dashboard screen

**Right:**
> Don't make it a reusable component. Compose it directly in the Dashboard mockup using atoms/molecules.
...
**Wrong:**
> Button component generated with only visual variants (primary, secondary, danger)

**Right:**
> Button component includes visual variants AND behavioral states (idle, hover, focus, loading, disabled)
...
**Wrong:**
> Here are 15 components I generated: Button, Input, Card, Modal, Badge, ...

**Right:**
> Here are 15 components mapped to PRD features:
> - Button (used in Create Task, Edit Task, Apply Filters, Delete Task)
> - Task List Item (used in Task List, Search Results, Filtered Views)
> - ...
...
- Tokens mode (Step 3): Where this process is invoked
- Visual quality rules: Accessibility and Gestalt constraints that apply to components
- Pencil templates: Ready-made examples for common atoms and molecules
