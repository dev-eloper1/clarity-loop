...
2. Update `docs/STATUS.md` — increment merged proposals count, update any relevant metrics
3. If verification found discrepancies where the system doc version was preferred over the proposal (or vice versa), log a Decision entry in `docs/DECISIONS.md` explaining what diverged and which version was kept
4. The manifest will be auto-regenerated by the PostToolUse hook since system docs changed
...
`/ui-designer setup` when ready to generate a design system."
